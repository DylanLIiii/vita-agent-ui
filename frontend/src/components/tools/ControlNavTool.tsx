...
import { Navigation, RotateCw, CheckCircle2, RotateCcw, MapPin, ArrowRight } from 'lucide-react';
...
export const ControlNavTool: React.FC<ControlNavToolProps> = ({ args, result }) => {
            ...
            <div className="p-4 space-y-4">
                ...
                <div className="flex items-start gap-3">
                    <div className="flex-1 space-y-1">
                        <div className="text-xs text-gray-400 font-medium uppercase tracking-wider">Requested Action</div>
